 ...
 * </p>
 */
public class SpireEmailReport implements IReporter {

    private static final Logger LOG = Logger.getLogger(SpireEmailReport.class);
...
//        writer.print("</tr>");
        ...
        for (SuiteResult suiteResult : suiteResults) {
        	if(suiteResult.getSuiteName().equalsIgnoreCase("Automation-Suite")){
        		continue;
        	}
        	writer.print("</br>");
        	writer.print("<div style='text-align:center'>");
			writer.print("<font face=verdana size=2 color=blue><pre><b><u>&#10146;"+suiteResult.getSuiteName()+"-Results");
			writer.print("</u></b></font></pre>");
             writer.print("</div>");
             
             writer.print("<center>");
             writer.print("<table border='1'>");
             writer.print("<tr bgcolor='#ffff00'>");
             writer.print("<th>Test</th>");
             writer.print("<th> Total Tests </th>");
            ...
            for (TestResult testResult : suiteResult.getTestResults()) {
                ...
                if(failedTests >0){
//                	writer.print("<th align='center' valign='middle' style=\"color:red;\">"+failedTests+"</th>");
                	writer.print("<th align='center' valign='middle' bgcolor='#FF5050'>"+failedTests+"</th>");
            ...
            writer.print("<tr bgcolor='add8e6'>");
            writer.print("<th>Total</th>");
            writeTableData(integerFormat.format(totalTests), "num");
            
            writeTableHeader(integerFormat.format(totalPassedTests), "num");
            if(totalFailedTests >0){
            	writer.print("<th align='center' valign='middle' bgcolor='#FF5050'>"+totalFailedTests+"</th>");
            }else{
            	  writeTableData(integerFormat.format(totalFailedTests), (totalFailedTests > 0 ? "num attn" : "num"));
            }
//            writeTableHeader(integerFormat.format(totalFailedTests), (totalFailedTests > 0 ? "num attn" : "num"));
           ...
           double total =  ((((double)totalPassedTests / (double)totalTests ))*100);
           if(total != 100){
        	   writer.print("<th align='center' valign='middle' bgcolor='#FF5050'>"+total+"</th>");
           }else{
...
//        if (testIndex >= 1) {
//        	writer.print("<div style='text-align:center'>");
//			writer.print("<font face=verdana size=2 color=red><b><u>Total Results");
//			writer.print("</u></b></font></pre>");
//             writer.print("</div>");
//             
//             
//             writer.print("<center>");
//             writer.print("<table border='1'>");
//             writer.print("<tr bgcolor='#228B22'>");
//             writer.print("<th>Test</th>");
//             writer.print("<th> Total Tests </th>");
//             
//             writer.print("<th> Tests Passed</th>");
...
//    	
//    	List<MethodResult> newMethods = new ArrayList<SpireEmailReport.MethodResult>();
//    	int i=0;
//    	
//    	for (MethodResult methodResult : methods) {
//    		
