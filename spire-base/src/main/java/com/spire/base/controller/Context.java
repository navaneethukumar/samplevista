...
public class Context {
  ...
  /*  public String getCandidatedisplayids() {
    	return (String) this.getAttribute("candidateDisplayIds");
	}
    public void setCANDIDATEDISPLAYIDS(String CANDIDATEDISPLAYIDS) {
		this.setAttribute(CANDIDATEDISPLAYIDS, CANDIDATEDISPLAYIDS);
	}
    public void setREQUISITIONDISPLAYIDS(String REQUISITIONDISPLAYIDS) {
		this.setAttribute(REQUISITIONDISPLAYIDS, REQUISITIONDISPLAYIDS);
	}
	public String getRequisitiondisplayids() {
		return (String) this.getAttribute("requisitionDisplayIds");
	}*/
    ...
    public Context(ITestContext context) {
        ...
        this.setContextAttribute(context, "test_type", System.getProperty("test_type"), null);
        ...
        this.setContextAttribute(context, "productName", System.getProperty("productName"), null);
    ...
    public String getContextAttribute(String attributeName, String defaultValue) {
		...
		this.contextDataMap.put(attributeName, (suiteValue != null ? suiteValue : defaultValue));
		return suiteValue;
