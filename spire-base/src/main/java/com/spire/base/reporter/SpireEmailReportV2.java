 ...
 * </p>
 */
public class SpireEmailReportV2 implements IReporter {

    private static final Logger LOG = Logger.getLogger(SpireEmailReportV2.class);
    ...
    private static List<ReportBean> resultList=new ArrayList<ReportBean>();
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
        ...
        ReportHelper.insertData(resultList);
    ...
    protected void writeHead() {
        writer.print("<head>");
        writer.print("<title>Spire Automation Report</title>");
    ...
    public List<MethodResult> removeFailedTest(List<MethodResult> methods){
    	...
    	List<MethodResult> newMethods = new ArrayList<SpireEmailReportV2.MethodResult>();
    	int i=0;
    ...
    protected static class TestResult {
        ...
        public TestResult(ITestContext context) {
            ...
            report.setFailedTestCases(failedTestCount);
            report.setTestSkipped(skippedTestCount);
            report.setPassedTestCases(passedTestCount);
            report.setTotalTestCases(totalTestCount);
            report.setPassePercentage(passPercent+"");
            report.setTimeTaken((int)duration);
            report.setIncludedGroups(includedGroups);
            report.setExcludedGroups(excludedGroups);
            //report.setEnvironment(ContextManager.getGlobalContext().getEnvironment());
            report.setEnvironment("prod");
            
            if (testName.toUpperCase().contains("sanity".toUpperCase()))
            	report.setTestType("SANITY");
            else if (testName.toUpperCase().equalsIgnoreCase("srg".toUpperCase()))
            	report.setTestType("SRG");
            else if (testName.toUpperCase().equalsIgnoreCase("lrg".toUpperCase()))
            	report.setTestType("LRG");
