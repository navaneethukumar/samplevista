 ...
 * </p>
 */
public class SpireReport implements IReporter {

    private static final Logger LOG = Logger.getLogger(SpireReport.class);
    ...
    public List<MethodResult> removeFailedTest(List<MethodResult> methods){
    	...
    	List<MethodResult> newMethods = new ArrayList<SpireReport.MethodResult>();
    	int i=0;
