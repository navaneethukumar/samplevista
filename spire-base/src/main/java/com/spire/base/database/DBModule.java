package com.spire.base.database;
...
public class DBModule {
	...
	public static Connection getStagingConnection() throws Exception {
		...
		Class.forName("com.mysql.jdbc.Driver").newInstance();
		Connection connection = DriverManager.getConnection(
				"jdbc:mysql://192.168.2.75:3306/automation_schema", dbProperties);
